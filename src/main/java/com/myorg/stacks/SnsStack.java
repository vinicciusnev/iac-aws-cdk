...
public class SnsStack extends Stack {
    @Getter private final SnsTopic productEventsTopic;
    ...
    public SnsStack(final Construct scope, final String id, final StackProps props) {
        ...
        productEventsTopic.getTopic().addSubscription(EmailSubscription.Builder.create("vinicciusneves23@hotmail.com")
                .json(true)
                .build());
    }
}
